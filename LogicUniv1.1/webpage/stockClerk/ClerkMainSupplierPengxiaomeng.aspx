...
<div class="col-lg-9 col-md-9 col-sm-9  white-bg right-container" id="rightlayer">
            ...
            <%-- BootStrap popup wind --%>
                 ...
                 <asp:GridView ID="GridView1" runat="server" AllowPaging="True" Height="354px" OnPageIndexChanging="GridView1_PageIndexChanging" Width="871px" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" DataKeyNames="supplierId" DataSourceID="SqlDataSource1" OnRowDataBound="GridView1_RowDataBound" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" CssClass="table table-striped table-bordered table-condensed">
                <Columns>
